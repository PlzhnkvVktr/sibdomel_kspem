...
data class TestItem(
    ...
    var calc_uv_ikas: MutableState<String> = mutableStateOf(""),
    var calc_vw_ikas: MutableState<String> = mutableStateOf(""),
    var calc_wu_ikas: MutableState<String> = mutableStateOf(""),
